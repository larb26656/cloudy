...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React42 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState24 = React42.useState, useEffect25 = React42.useEffect, useLayoutEffect3 = React42.useLayoutEffect, useDebugValue = React42.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var ContextMenuTrigger = React18.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME5, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React18.useRef({ x: 0, y: 0 });
    const virtualRef = React18.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React18.useRef(0);
    const clearLongPress = React18.useCallback(
    ...
    React18.useEffect(() => clearLongPress, [clearLongPress]);
    React18.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React18.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React18.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React18.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React18.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React18.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React18.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React18.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React18.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React18.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React18.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React18.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React18.forwardRef((props, forwardedRef) => {
...
var NAME5 = "Label";
var Label3 = React20.forwardRef((props, forwardedRef) => {
...
var Form = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const [validityMap, setValidityMap] = React21.useState({});
    const getFieldValidity = React21.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React21.useCallback(
    ...
    const handleFieldValiditionClear = React21.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React21.useState({});
    const getFieldCustomMatcherEntries = React21.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React21.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React21.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React21.useState({});
    const getFieldCustomErrors = React21.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React21.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React21.useState({});
    const handleFieldMessageIdAdd = React21.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React21.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React21.useCallback(
...
var FormLabel = React21.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React21.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React21.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React21.forwardRef(
  (props, forwardedRef) => {
...
var FormBuiltInMessage = React21.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React21.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React21.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React21.forwardRef(
  (props, forwardedRef) => {
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React23.useRef(false);
  const isPointerDownOnContentRef = React23.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React23.useCallback(() => setOpen(false), [setOpen]);
  React23.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React23.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContent = React23.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React23.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React23.useState(false);
  React23.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React23.forwardRef(
  (props, forwardedRef) => {
...
var Menubar = React24.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React24.useState(null);
    return (0, import_jsx_runtime21.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React24.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React24.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React24.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React24.useRef(false);
...
var MenubarTrigger = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React24.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React24.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React24.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenu = React25.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React25.useState(null);
    ...
    const startCloseTimer = React25.useCallback(() => {
...
var NavigationMenuSub = React25.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React25.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React25.useState(null);
  return (0, import_jsx_runtime22.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React25.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React25.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuItem = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React25.useRef(null);
    const restoreContentTabOrderRef = React25.useRef(() => {
    });
    const wasEscapeCloseRef = React25.useRef(false);
    const handleContentEntry = React25.useCallback((side = "start") => {
    ...
    const handleContentExit = React25.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates(contentRef.current);
...
var NavigationMenuTrigger = React25.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React25.useRef(false);
...
var NavigationMenuIndicator = React25.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React25.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React25.useState(
    null
  );
  const [position, setPosition] = React25.useState(null);
...
var NavigationMenuContent = React25.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React25.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME10, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React25.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React25.useRef(null);
  ...
  const motionAttribute = React25.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React25.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React25.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React25.useState(null);
...
var FocusGroup = React25.forwardRef(
  (props, forwardedRef) => {
...
var FocusGroupItem = React25.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var OneTimePasswordField = React26.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React26.useCallback(
      (value2) => {
    ...
    const controlledValue = React26.useMemo(() => {
    ...
    const validationTypeRef = React26.useRef(validation);
    React26.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React26.useRef(null);
    const userActionRef = React26.useRef(null);
    ...
    const locateForm = React26.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React26.useCallback(() => {
    ...
    const valueRef = React26.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React26.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React26.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React26.useState(null);
  ...
  const keyboardActionTimeoutRef = React26.useRef(null);
  React26.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React27.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React27.useCallback(
  ...
  const focusState = React27.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React27.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React27.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React27.useState(void 0);
...
var PasswordToggleFieldIcon = React27.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
var ProgressIndicator = React29.forwardRef(
  (props, forwardedRef) => {
...
var Radio = React30.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
...
var RadioIndicator = React30.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = React30.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime30.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime30.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime30.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime30.jsx)(
        ...
        isFormControl2 ? (0, import_jsx_runtime30.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
...
var SelectPortal = (props) => {
  return (0, import_jsx_runtime30.jsx)(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM3.createPortal(
        (0, import_jsx_runtime30.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime30.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime30.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime30.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var SelectContentImpl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst5 = React32.useCallback(
      (candidates) => {
...
var SelectArrow = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime30.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
...
var Root212 = Select;
var Trigger9 = SelectTrigger;
var Value = SelectValue;
var Icon = SelectIcon;
var Portal6 = SelectPortal;
var Content210 = SelectContent;
...
var Separator4 = React33.forwardRef((props, forwardedRef) => {
...
var Slider = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React34.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React34.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React34.useRef(values);
...
var SliderHorizontal = React34.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React34.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React34.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React34.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const sliderRef = React34.useRef(null);
...
var SliderImpl = React34.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React34.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React34.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React34.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React34.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React34.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime32.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
var SliderThumbImpl = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime32.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime32.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime32.jsx)(
            Primitive.span,
            {
              role: "slider",
...
var SliderBubbleInput = React34.forwardRef(
...
var Switch = React35.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime33.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
...
var TabsList = React36.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React36.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React36.useRef(isSelected);
    React36.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React37.useState(0);
  const isFocusedToastEscapeKeyDownRef = React37.useRef(false);
  const isClosePausedRef = React37.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime35.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime35.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React37.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React37.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React37.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React37.useRef(null);
    const tailFocusProxyRef = React37.useRef(null);
    ...
    const getSortedTabbableCandidates = React37.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React37.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React37.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const pointerStartRef = React37.useRef(null);
    const swipeDeltaRef = React37.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React37.useRef(0);
    const closeTimerRemainingTimeRef = React37.useRef(duration);
    ...
    const startTimer = React37.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React37.useMemo(() => {
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React37.useState(false);
  const [isAnnounced, setIsAnnounced] = React37.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React37.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime35.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime35.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React37.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React37.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React37.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React37.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React37.forwardRef((props, forwardedRef) => {
...
var Toolbar = React40.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React40.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React40.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarLink = React40.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleGroup = React40.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React40.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime38.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime38.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var [PortalProvider4, usePortalContext4] = createTooltipContext(PORTAL_NAME9, {
  forceMount: void 0
});
var TooltipPortal = (props) => {
  const { __scopeTooltip, forceMount, children, container } = props;
  const context = useTooltipContext(PORTAL_NAME9, __scopeTooltip);
  return (0, import_jsx_runtime39.jsx)(PortalProvider4, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime39.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime39.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME9;
var CONTENT_NAME14 = "TooltipContent";
var TooltipContent = React41.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext4(CONTENT_NAME14, props.__scopeTooltip);
